...
if (!webgl_detect()) document.getElementById("webGLwarning").style.display = "block";
...
{    
	...
	//scene.clearColor = new BABYLON.Color4(0.81, 0.81, 0.81, 1); 
	...
	var camera = new BABYLON.ArcRotateCamera("Camera",3, 1.35, 300, BABYLON.Vector3.Zero(), scene);
	//camera.inertia = 0.5;
	...
	scene.registerBeforeRender(function () {
		//console.log(camera.beta, camera.alpha, camera.radius)
	})
